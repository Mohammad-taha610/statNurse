        ...
        <div class="tabbable">
            ...
            <div class="tab-content profile-edit-tab-content">
                <div id="edit-basic" class="tab-pane active">
                    ...
                    <div class="row">
                        <form id="material-form" class="form-horizontal material-form" method="POST" action="@url('save_nurse',{'id':$id})">
                            <div class="col-md-6 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <label for="title">First Name</label>
                                    <input  class="form-control" name="name" type="text" placeholder="First Name" value="<?=$first_name?>"/>
                                </div>
                                <div class="form-group">
                                    <label for="title">Last Name</label>
                                    <input  class="form-control" name="name" type="text" placeholder="Last Name" value="<?=$last_name?>"/>
                                </div>
                            </div>
                            <div class="col-md-6 col-sm-12 col-xs-12">
                                <div class="form-group">
