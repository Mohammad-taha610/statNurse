...
class ShiftRecurrence extends EventRecurrence{
    ...
    /**
     * @ManyToOne(targetEntity="\nst\member\Nurse", inversedBy="shiftRecurrences")
     */
    protected $nurse;

    /**
     * @ManyToOne(targetEntity="\nst\member\Provider", inversedBy="shiftRecurrences")
     */
    protected $provider;
    ...
    /**
     * @var boolean $provider_approved
     * @Column(type="boolean", nullable=true)
     */
    protected $provider_approved;

    /**
     * @var boolean $nurse_approved
     * @Column(type="boolean", nullable=true)
     */
     ...
     * @OneToOne(targetEntity="\nst\payroll\PayrollPayment", inversedBy="shift_recurrence")
