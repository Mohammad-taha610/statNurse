                                            ...
                                            <div class="input-group">
                                                <input type="text" name="start_date"
                                                       ...
                                                       value="<?= (isset($recurrence['start']))
                                                           ? $recurrence['start']->format('m/d/Y') : $event->getStart()->format('m/d/Y') ?>">
                                            ...
                                            <div class="input-group">
                                                <input type="text" name="end_date" class="form-control" title="End Date"
                                                       value="<?= (isset($recurrence['end']))
                                                           ? $recurrence['end']->format('m/d/Y') : $event->getEnd()->format('m/d/Y') ?>">
                                                <span class="input-group-addon">
                                                    <i class="fa fa-calendar" aria-hidden="true"></i>
                                                </span>
                                            </div>
                                ...
                                <div id="time-container" class="time-container <?= ($isAllDay) ? 'time-hidden' : '' ?>">
                                    <div class="row">
                                        <div class="col-md-4">
                                            ...
                                            else if(!is_null($event->getStartTime())) {
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            else if(!is_null($event->getEndTime())) {
