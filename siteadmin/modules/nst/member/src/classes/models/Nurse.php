...
class Nurse {
    ...
    /**
     * @var string $checkr_pay_id
     * @Column(type="string", nullable=true)
     */
    protected $checkr_pay_id;
     ...
     * @OneToMany(targetEntity="\nst\payroll\Payroll", mappedBy="nurse", fetch="LAZY")
     */
    protected $payrolls;
     ...
     * @OneToMany(targetEntity="\nst\events\Shift", mappedBy="nurse")
     ...
     * @OneToMany(targetEntity="NstFile", mappedBy="nurse")
     */
    protected $nurse_files;

    /**
     * @var saFile $drug_screen_file
     * @OneToOne(targetEntity="NstFile", mappedBy="nurse")
     */
    protected $drug_screen_file;

    /**
     * @var saFile $covid_vaccine_file
     * @OneToOne(targetEntity="NstFile", mappedBy="nurse", cascade={"persist"})
     */
    protected $covid_vaccine_file;

    /**
     * @var boolean $is_vaccinated
     * @Column(type="boolean", nullable=true)
     */
    ...
    /**
     * @var integer $quickbooks_vendor_id
     * @Column(type="integer", nullable=true)
     */
    ...
    /**
     * @var boolean $receives_push_notification
     * @Column(type="boolean", nullable=false, options={"default": false})
     */
     ...
     * @ManyToMany(targetEntity="nst\system\NstState", inversedBy="nurse_working_states")
     ...
     * @ManyToMany(targetEntity="nst\messages\NstMessage", inversedBy="nurses")
     ...
     * @return Nurse
     */
    public function addBlockedProvider(\nst\member\Provider $blocked_provider)
    {
     ...
     * @return boolean TRUE if this collection contained the specified element, FALSE otherwise.
     */
    public function removeBlockedProvider(\nst\member\Provider $blocked_provider)
    {
     ...
     * @return string
     */
    public function getCheckrPayId()
    {
        return $this->checkr_pay_id;
    }

    /**
     * @param string $checkr_pay_id
     * @return Nurse
     */
    public function setCheckrPayId($checkr_pay_id)
    {
        $this->checkr_pay_id = $checkr_pay_id;
        return $this;
    }
    ...
    /**
     * @param integer $quickbooks_vendor_id
     * @return Nurse
     */
     ...
     *
     * @param boolean $receives_push_notification
     * @return Nurse
     */
