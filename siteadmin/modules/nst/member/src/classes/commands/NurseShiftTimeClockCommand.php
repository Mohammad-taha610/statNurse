 ...
 * Date: 6/17/2021
 *
 * File: NurseShiftTimeClockCommand.php
 */
class NurseShiftTimeClockCommand extends Command
{
    protected function configure() {
        $this->setName('nurse:shift_time_clock')
    ...
    protected function execute(InputInterface $input, OutputInterface $output) {
        ...
        if($standardHours) {
            ...
            $payment->setPayTotal($paymentAmount);
            $payment->setPayRate($payRate);
            $payment->setBillTotal($billingAmount);
