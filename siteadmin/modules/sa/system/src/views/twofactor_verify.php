                ...
                <div>
                    ...
                    <div class="row">
                        <div class="col-md-12 text-center">
                            ...
                            ?>
                            <div style="">
                                As an added level of security, <br />we require you to use two factor authentication. <br /> <br />
...
<script>
    ...
    $('#btn-send-now').click( function() {
        ...
        $('#btn-send-now').hide();
        $('#btn-sending').show();
        modRequest.request('sa.verify.two_factor_send_code', null, null, function() {
    ...
    $('#btn-verify-now').click( function() {
        ...
        $('#error').hide();
        modRequest.request('sa.verify.two_factor_verify_code', null, { 'code': $('#code').val() }, function(data) {
