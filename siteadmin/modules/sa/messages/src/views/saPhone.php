...
<form class="form-horizontal" role="form" method="post" action="<?=$postRoute?>">
	<div class="form-group">
		...
		<div class="col-sm-9">
			<input type="text" name="phone" id="form-field-1" value="<?=$phone?>" placeholder="Phone" class="col-xs-10 col-sm-5">
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-sm-9">
			<select name="type" id="form-field-2" class="col-xs-10 col-sm-5">
				...
				<option <?=$type=='mobile' ? 'selected="selected"' : ''?> value="mobile">Mobile</option>
