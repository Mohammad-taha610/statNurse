...
<div class="account-wrapper">
    <div class="account-body">
        ...
        <form action="<?=$url->make('member_machineverifycode')?>" method="post">
            <div class="row" style="margin-top:25px">
                <div class="col-sm-12">
                    <label>As an added level of security, we require you to verify the computer you are using.<br /><br />
