...
<?php $nstAssetfolder = '/themes/nstAdmin/assets'; ?>
...
<head>
    ...
    <link rel="stylesheet" href="/themes/nst/assets/css/nstSaStyles.css">
    <link rel="stylesheet" href="/themes/nst/assets/css/saResponsive.css">
    <link rel="stylesheet" href="<?=$nstAssetfolder?>/css/shift-action-log.css">
    ...
    <script src="/themes/nst/js/nst_error_notification_vue.js"></script>
</head>
<body>
@show
...
<div class="navbar navbar-default" id="navbar" style="background: <?=$backgroundColor ?>;">
    ...
    <div class="navbar-container" id="navbar-container">
        <div class="navbar-header pull-left">
            ...
            <?php
            if (\sacore\application\app::getIsInSafeMode()) {
                echo '<a class="safe-mode-link navbar-brand" href="'.\sacore\application\app::get()->getRouter()->generate('system_safemode').'"><small> | SAFE MODE</small></a>';
                echo '<a class="safe-mode-link navbar-brand" href="'.\sacore\application\app::get()->getRouter()->generate('system_safemode_disable').'"><small> [ DISABLE ] </small></a>';
            }
            ?>
...
<div class="main-container" id="main-container">
    ...
    <div class="sidebar responsive" id="sidebar">
        ...
        $nstSystemService = new \nst\system\NstSystemService();
        $menuItems = $nstSystemService->filterNavThroughPermissions($this->appContext->navigation->get());
        ...
        <div class="breadcrumbs" id="breadcrumbs">
            <ul class="breadcrumb">
                ...
                <?php
                    ...
                    {
                        // Skip the first two links as they are currently useless for SA breadcrumbs
                        if ($i <= 1) { continue; }
                        if ($link['active'])
                        {
                            ?>
