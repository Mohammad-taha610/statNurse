...
class saMemberUsers
{
    ...
    #[ManyToOne(targetEntity: saMember::class, fetch: 'EAGER', inversedBy: 'users')]
    protected $member;
    ...
    #[ManyToMany(targetEntity: saMemberGroup::class, fetch: 'EAGER')]
    #[JoinTable(name: 'samemberusers_samembergroup')]
    #[JoinColumn(name: 'samemberusers_id', referencedColumnName: 'id')]
    #[InverseJoinColumn(name: 'samembergroup_id', referencedColumnName: 'id')]
    protected $groups;
    ...
    public function validate()
    {
        ...
        if (! $this->getId()) {
            ...
            $users = app::$entityManager->getRepository($saMemberUsers)->findBy(['username' => $this->username]);
            if ($users) {
    ...
    public static function requestResetPassword($username, $sendEmail = true, $ttl = 2700)
    {
        ...
        /** @var saMemberUsers $user */
        $user = app::$entityManager->getRepository($saMemberUsers)->findOneBy(['username' => $username, 'is_active' => true]);
