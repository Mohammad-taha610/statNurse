...
#[DiscriminatorMap(["shift" => Shift::class])]
#[Table("Event")]
class Event
{
    ...
    public const WEEKDAY_SUN = 'SU';

    public const WEEKDAY_MON = 'MO';

    public const WEEKDAY_TUES = 'TU';

    public const WEEKDAY_WED = 'WE';

    public const WEEKDAY_THURS = 'TH';

    public const WEEKDAY_FRI = 'FR';

    public const WEEKDAY_SAT = 'SA';

    public const MONTH_JAN = 0;

    public const MONTH_FEB = 1;

    public const MONTH_MAR = 2;

    public const MONTH_APR = 3;

    public const MONTH_MAY = 4;

    public const MONTH_JUN = 5;

    public const MONTH_JUL = 6;

    public const MONTH_AUG = 7;

    public const MONTH_SEP = 8;

    public const MONTH_OCT = 9;

    public const MONTH_NOV = 10;

    public const MONTH_DEC = 11;

    public const LARGE_NUMBER = 1000000000;
