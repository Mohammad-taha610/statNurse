...
class Reservation
{
     ...
     * @var Event
     */
    #[ManyToOne(targetEntity: Event::class, inversedBy: 'reservations')]
    protected $event;

    #[ManyToOne(targetEntity: EventRecurrence::class, inversedBy: 'reservations')]
    #[JoinColumn(name: 'eventRecurrence_id', referencedColumnName: 'id')]
