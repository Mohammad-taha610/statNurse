...
class PayrollPayment
{
     ...
     * @var Shift $shift
     */
    #[ManyToOne(targetEntity: Shift::class, inversedBy: 'payroll_payments')]
    protected $shift;

    /**
     * @var ShiftRecurrence $shift_recurrence
     */
    #[ManyToOne(targetEntity: ShiftRecurrence::class, inversedBy: 'payroll_payments')]
    ...
    /**
     * @var int $quickbooks_bill_id
     */
    #[Column(type: 'integer', nullable: true)]
    protected $quickbooks_bill_id;

    /**
     * @var int $quickbooks_bill_payment_id
     */
    #[Column(type: 'integer', nullable: true)]
    protected $quickbooks_bill_payment_id;

    /**
     * @var int $quickbooks_purchase_id
     */
    #[Column(type: 'integer', nullable: true)]
