...
class Provider
{
     ...
     */
    #[OneToMany(mappedBy: 'provider', targetEntity: Shift::class)]
    protected $shifts;

    /**
     * @var ArrayCollection $shift_recurrences
     */
    #[OneToMany(mappedBy: 'provider', targetEntity: ShiftRecurrence::class)]
     ...
     */
    #[OneToMany(mappedBy: 'provider', targetEntity: NstInvoice::class)]
    protected $invoices;
    ...
    /**
     * @var int $quickbooks_customer_id
     */
     ...
     */
    #[OneToMany(targetEntity: NstFile::class, mappedBy: 'provider')]
    protected $provider_files;

    /**
     * @var ArrayCollection $contacts
     */
    #[OneToMany(targetEntity: NstContact::class, mappedBy: 'provider')]
    protected $contacts;
    ...
    /**
     * @var bool $uses_travel_pay
     */
    #[Column(type: 'boolean', nullable: true)]
    protected $uses_travel_pay;

    /**
     * @var bool $has_covid_pay
     */
    #[Column(type: 'boolean', nullable: true)]
    ...
    /**
     * @var bool $requires_covid_vaccine
     */
    #[Column(type: 'boolean', nullable: true)]
    ...
    #[InverseJoinColumn(name: 'nstfiletag_id', referencedColumnName: 'id')]
     ...
     */
    #[OneToMany(targetEntity: CustomNstFileTag::class, mappedBy: 'provider')]
    ...
    #[JoinColumn(name: 'provider_id', referencedColumnName: 'id')]
    #[InverseJoinColumn(name: 'nursecredential_id', referencedColumnName: 'id')]
    private $nurseCredentials;

    /**
     * One Provider has Many PresetShiftTimes. This is the inverse side.
     */
    #[OneToMany(mappedBy: 'provider', targetEntity: PresetShiftTime::class)]
    private $presetShiftTimes;

    /**
     * @var int $breakLengthInMinutes
     */
    #[Column(type: 'integer', nullable: true, options: ['default' => 30], name: 'breakLengthInMinutes')]
    private $breakLengthInMinutes;

    #[ManyToMany(targetEntity: Nurse::class, mappedBy: 'preferred_providers')]
    protected $preferred_nurses;
    ...
    /**
     * @param  int  $quickbooks_customer_id
     * @return Provider
     */
