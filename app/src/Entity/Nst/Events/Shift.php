...
use App\Entity\Sax\Events\Event;
...
#[Entity(repositoryClass: ShiftRepository::class)]
...
class Shift extends Event
{
    ...
    #[ManyToOne(targetEntity: Nurse::class, inversedBy: 'shifts')]
    protected $nurse;
     ...
     */
    #[ManyToOne(targetEntity: Provider::class, inversedBy: 'shifts')]
    protected $provider;
     ...
     */
    #[OneToOne(inversedBy: 'shift', targetEntity: PayrollPayment::class)]
     ...
     */
    #[OneToMany(mappedBy: 'shift', targetEntity: PayrollPayment::class, cascade: ['remove'])]
    protected $payroll_payments;

    /**
     * @var PayrollPayment $overtime_payment
     */
    #[OneToOne(targetEntity: PayrollPayment::class, inversedBy: 'shift')]
     ...
     * @var bool $isOnBreak
     */
    #[Column(type: 'boolean', nullable: true, options: ['default' => '0'], name: 'isOnBreak')]
    protected $isOnBreak;

    /**
     * @var DateTime $breakStartTime
     */
    #[Column(type: 'datetime', nullable: true, name: 'breakStartTime')]
    protected $breakStartTime;

    /**
     * @var bool $hasTakenBreak
     */
    #[Column(type: 'boolean', nullable: true, options: ['default' => '0'], name: 'hasTakenBreak')]
    ...
    protected function validateRecurrenceRules()
    {
        ...
        if (
            $this->isRecurring() && in_array($this->frequency, [Event::FREQUENCY_DAILY, Event::FREQUENCY_WEEKLY])
